<template>
      ...
      <v-card outlined title="Personal Detail">
        <v-card-text>
          <v-row>
            ...
            <v-col cols="12" md="4">
              <label class="v-label mb-2 text-subtitle-2">
                <span class="text-red mr-2">*</span> Resume No :
              </label>
              <v-text-field
                v-model="formInput.title"
                dense
      ...
      <v-card outlined title="Admission Detail">
        <v-card-text>
          <v-row>
            ...
            <v-col cols="12" md="4">
              <label class="v-label mb-2 text-subtitle-2">
                <span class="text-red mr-2">*</span> Score for kids :
              </label>
              <v-text-field
                v-model="formInput.title"
                dense
            ...
            <v-col cols="12" md="4">
              <label class="v-label mb-2 text-subtitle-2">
                <span class="text-red mr-2">*</span> Score for Adult :
              </label>
              <v-text-field
                v-model="formInput.title"
                dense
            ...
            <v-col cols="12" md="4">
              <label class="v-label mb-2 text-subtitle-2">
                <span class="text-red mr-2">*</span> Teacher type :
              </label>
              <v-select
                v-model="formInput.title"
                :items="[]"
            ...
            <v-col cols="12" md="4">
              <label class="v-label mb-2 text-subtitle-2">
                <span class="text-red mr-2">*</span> Register No :
              </label>
              <v-text-field
                v-model="formInput.title"
                dense
            ...
            <v-col cols="12" md="4">
              <label class="v-label mb-2 text-subtitle-2">
                <span class="text-red mr-2">*</span> Available for class:
              </label>
              <v-select
                v-model="formInput.title"
            ...
            <v-col cols="12" md="4">
              <label class="v-label mb-2 text-subtitle-2"> Language : </label>
              <v-text-field
                v-model="formInput.title"
                dense
                outlined
  ...
  <v-row justify="center" dense class="mt-6">
    <v-col cols="12">
      <v-card outlined title="Teacher fee structure">
        <v-card-text>
              ...
              <v-row>
                <v-col cols="12" md="4">
                  <v-row>
                    <v-col cols="12">
                      <label class="v-label mb-2 text-subtitle-2">
                        <span class="text-red mr-2">*</span> Update Date :
                      </label>
                      <v-text-field
                        v-model="date"
                ...
                <v-col cols="12" md="4">
                  ...
                  <div class="position-absolute top-0 right-0 d-flex ga-2 pa-2">
                    <v-btn
                      color="info"
                      dense
  ...
  <v-row justify="center" dense class="mt-6">
    <v-col cols="12">
      <v-card outlined title="Teacher score structure">
        <v-card-text>
          <v-card color="grey-lighten-4" variant="flat">
            <v-card-text>
              <v-row>
                <v-col cols="12" md="4">
                  <label class="v-label mb-2 text-subtitle-2">
                    <span class="text-red mr-2">*</span> Update score Date :
                  </label>
                  <v-text-field
                    v-model="date"
